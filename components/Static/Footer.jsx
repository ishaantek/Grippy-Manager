          ...
          <div className="pt-10 mx-auto">
            <div className="lg:grid lg:grid-cols-6 gap-20">
              <div className="col-span-3">
                <div className="flex items-center space-x-5">
                  <img
                    src="https://media.discordapp.net/attachments/1081656082881069147/1081954335870681158/Lo.png"
              ...
              <div className="col-span-1">
                ...
                <div>
                  <a
                    href="https://discord.gg/P2KBYJZkUc"
                    target="_blank"
              ...
              <div className="col-span-1">
                ...
                <div>
                  <Link href="https://discord.gg/P2KBYJZkUc">
                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                ...
                <div>
                  <Link href="https://twitter.com/grippysuk">
                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                ...
                <div>
                  <Link href="https://youtube.com/@GrippysUK">
                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
            ...
            <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
              <p className="text-white text-center sm:text-left text-opacity-50">
                &copy; Grippy Manager {new Date().getFullYear()}, All Rights Reserved.
              </p>
              <div className="hidden md:flex items-center justify-center">
              </div>
              <p className="text-white text-center sm:text-right text-opacity-50">
                {"Made with love by Ishaantek.com ❤️"}
              </p>
            </div>
          </div>
        </footer>

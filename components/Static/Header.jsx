            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        ...
                        <p className=" font-extrabold ml-1 text-2xl">Grippy Manager</p>
                    </div>
                ...
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            <img src="https://media.discordapp.net/attachments/1081656082881069147/1081954335870681158/Lo.png" 
                                className={`
                                    rounded-full 
                                `}
                                width="48" height="48"
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">Grippy</span>Manager</a>
                            </p>
                        </div>
